...
content = '''"""Pure logic for Network Spotlight: foreground/background/dominant computation."""
...
pathlib.Path('src/net_monitor/ui/network_spotlight.py').write_text(content, encoding='utf-8')
print('OK')
